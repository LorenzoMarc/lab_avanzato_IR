...
def parse_arguments():
    ...
    parser.add_argument('-out','--output_dir', type=str, default="./modelsave3003")
    ...
    parser.add_argument('-decay', '--weight_decay', type=float, default=0.01)
    ...
    parser.add_argument('-tr_size', '--train_size', type=float, default=0.7)
    ...
    parser.add_argument('-f','--fake', type=bool, default=True)
